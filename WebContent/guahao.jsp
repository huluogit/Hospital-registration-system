...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <tr>
      ...
      <a class="button border-main" href="javascript:void(0)" onclick="update(${alldoctor.dNumber})"><span class="icon-edit"></span> 挂号</a>
      <a class="button border-red" href="javascript:void(0)" onclick="del(${alldoctor.dNumber})"><span class="icon-trash-o"></span> 撤销</a>
      </div></td>
    </tr>
     </c:forEach> 
     <tr>
...
function update(id){
	if(id!=""){
		window.location.href = "guahao?dNumber="+id;
	}
